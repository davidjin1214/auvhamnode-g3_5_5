...
> **历史文档（2026-04-05 写就，2026-08-20 加注）。** 本文的结果部分建立在 catalog 时代 A 区
> 的 `phnode_full clean seed42/46` 之上，而这两个 run 已被 provenance audit 判定为
> `stale_environment_drift`（环境耦合的历史异常，当前环境重训自愈、不可复现），
> **不得再作为模型脆弱性的证据**——见 `docs/provenance_audit_phnode_full_clean.md`
> 与 `analysis/oc_data_catalog/evidence_status_overrides.csv`。
>
> 当前 clean 基线以 `docs/phase1a_oc_v4lite_cleanrun_v1_report.md` 为准；论文正文的
> 主证据口径见 `docs/section8_evidence_merge_plan.md`（R-A 规则）。
> 本文保留的价值在于评估协议与指标定义的说明，以及 A 区实验的历史记录。
...
- [all-model seed audit](checkpoints/sweep_oc_all/all_model_review_seed_audit.md)
- [all-model compact summary](checkpoints/sweep_oc_all/all_model_review_summary_compact.md)
- [all-model detailed summary](checkpoints/sweep_oc_all/all_model_review_summary_detailed.md)
- [core vs ablation historical summary](checkpoints/sweep_oc_all/oc_core_vs_oc_ablation_summary.md)
- [PHNODE 6-seed focus summary](checkpoints/sweep_oc_all/phnode_focus_6seed_summary.md)
...
Model metadata comes from [auv_model_registry.py](auv_model_registry.py).
...
- [build_cross_model_summary.py](scripts/build_cross_model_summary.py)
...
1. [Chinese results section](docs/oc_results_section_zh.md)
2. [All-model compact summary](checkpoints/sweep_oc_all/all_model_review_summary_compact.md)
3. [All-model detailed summary](checkpoints/sweep_oc_all/all_model_review_summary_detailed.md)
4. [All-model seed audit](checkpoints/sweep_oc_all/all_model_review_seed_audit.md)

### Sweep Reports

| Sweep | Report | Metrics Table |
| --- | --- | --- |
| Core sweep | [experiment_report.md](checkpoints/sweep_oc_all/sweep_oc_core_default_auv_oc_traj1000_blk150_s23_d0be9434_s42-43-44_20260404_115414/experiment_report.md) | [sweep_model_metrics.csv](checkpoints/sweep_oc_all/sweep_oc_core_default_auv_oc_traj1000_blk150_s23_d0be9434_s42-43-44_20260404_115414/sweep_model_metrics.csv) |
| Ablation sweep | [experiment_report.md](checkpoints/sweep_oc_all/sweep_oc_ablation_default_auv_oc_traj1000_blk150_s23_d0be9434_s42-43-44_20260404_143830/experiment_report.md) | [sweep_model_metrics.csv](checkpoints/sweep_oc_all/sweep_oc_ablation_default_auv_oc_traj1000_blk150_s23_d0be9434_s42-43-44_20260404_143830/sweep_model_metrics.csv) |
| PHNODE supplementary sweep | [experiment_report.md](checkpoints/sweep_oc_all/sweep_oc_phnode_focus_extra3_auv_oc_traj1000_blk150_s23_d0be9434_s45-46-47/experiment_report.md) | [sweep_model_metrics.csv](checkpoints/sweep_oc_all/sweep_oc_phnode_focus_extra3_auv_oc_traj1000_blk150_s23_d0be9434_s45-46-47/sweep_model_metrics.csv) |

### Consolidated Reports

| Purpose | File |
| --- | --- |
| Full seed-level judgement | [all_model_review_seed_audit.md](checkpoints/sweep_oc_all/all_model_review_seed_audit.md) |
| Quick ranking | [all_model_review_summary_compact.md](checkpoints/sweep_oc_all/all_model_review_summary_compact.md) |
| Detailed metrics | [all_model_review_summary_detailed.md](checkpoints/sweep_oc_all/all_model_review_summary_detailed.md) |
| Historical compatibility summary | [all_model_performance_with_pruned_variants.md](checkpoints/sweep_oc_all/all_model_performance_with_pruned_variants.md) |
| Historical core-vs-ablation view | [oc_core_vs_oc_ablation_summary.md](checkpoints/sweep_oc_all/oc_core_vs_oc_ablation_summary.md) |
| PHNODE-only six-seed view | [phnode_focus_6seed_summary.md](checkpoints/sweep_oc_all/phnode_focus_6seed_summary.md) |
...
| Use Case | File |
| --- | --- |
| `main/phnode_full` bad-outlier seed `42`: rollout growth | [error_growth.png](checkpoints/sweep_oc_all/sweep_oc_core_default_auv_oc_traj1000_blk150_s23_d0be9434_s42-43-44_20260404_115414/main_phnode_full_seed42/rollout_benchmark/resampled_traj30_seed42_20260405_004246/error_growth.png) |
| `main/phnode_full` bad-outlier seed `42`: example rollouts | [example_rollouts.png](checkpoints/sweep_oc_all/sweep_oc_core_default_auv_oc_traj1000_blk150_s23_d0be9434_s42-43-44_20260404_115414/main_phnode_full_seed42/rollout_benchmark/resampled_traj30_seed42_20260405_004246/example_rollouts.png) |
| `main/phnode_full` catastrophic seed `46`: rollout growth | [error_growth.png](checkpoints/sweep_oc_all/sweep_oc_phnode_focus_extra3_auv_oc_traj1000_blk150_s23_d0be9434_s45-46-47/main_phnode_full_seed46/rollout_benchmark/resampled_traj30_seed42_20260405_111554/error_growth.png) |
| `main/phnode_full` catastrophic seed `46`: terminal error spread | [terminal_error_boxplots.png](checkpoints/sweep_oc_all/sweep_oc_phnode_focus_extra3_auv_oc_traj1000_blk150_s23_d0be9434_s45-46-47/main_phnode_full_seed46/rollout_benchmark/resampled_traj30_seed42_20260405_111554/terminal_error_boxplots.png) |
| `main/phnode_full` catastrophic seed `46`: example rollouts | [example_rollouts.png](checkpoints/sweep_oc_all/sweep_oc_phnode_focus_extra3_auv_oc_traj1000_blk150_s23_d0be9434_s45-46-47/main_phnode_full_seed46/rollout_benchmark/resampled_traj30_seed42_20260405_111554/example_rollouts.png) |
| Best current PHNODE seed `ablate_no_lift_seed45`: rollout growth | [error_growth.png](checkpoints/sweep_oc_all/sweep_oc_phnode_focus_extra3_auv_oc_traj1000_blk150_s23_d0be9434_s45-46-47/ablation_ablate_no_lift_seed45/rollout_benchmark/resampled_traj30_seed42_20260405_113743/error_growth.png) |
| Best current PHNODE seed `ablate_no_lift_seed45`: terminal error spread | [terminal_error_boxplots.png](checkpoints/sweep_oc_all/sweep_oc_phnode_focus_extra3_auv_oc_traj1000_blk150_s23_d0be9434_s45-46-47/ablation_ablate_no_lift_seed45/rollout_benchmark/resampled_traj30_seed42_20260405_113743/terminal_error_boxplots.png) |
| Best current PHNODE seed `ablate_no_lift_seed45`: example rollouts | [example_rollouts.png](checkpoints/sweep_oc_all/sweep_oc_phnode_focus_extra3_auv_oc_traj1000_blk150_s23_d0be9434_s45-46-47/ablation_ablate_no_lift_seed45/rollout_benchmark/resampled_traj30_seed42_20260405_113743/example_rollouts.png) |
