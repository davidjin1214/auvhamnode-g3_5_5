...
| 正文草稿 | in_progress | `drafts/auvhamnode_thesis_chapter_zh.tex` 第 1--5 节已完成阶段性正文，10 节结构已切入主稿，`drafts/auvhamnode_thesis_chapter_zh.pdf` 已按最新 TeX 编译更新 | 继续扩写第 6--7 节，并在 current evidence 表导出后填写第 8 节 |
