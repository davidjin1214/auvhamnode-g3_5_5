...
| Fossen-to-structure 桥梁节 | done | 当前主稿第 4 节已调整为“从六自由度能量--功率关系到结构保持学习模型”，统一 \(\nu_r\) 功率配对、弱化具体仿真器叙事并补充端口哈密顿适用边界 | 后续只随第 5--6 节符号和功率边界做一致性修订 |
...
| P3a | 新增并修订“从六自由度能量--功率关系到结构保持学习模型” | 正文第 4 节完整正文 v2 + 最新 PDF 编译 | done |
