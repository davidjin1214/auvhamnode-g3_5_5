...
| 图表清单 | done（待终稿视觉复核） | 速度变量关系图、模型定义总览图、机械核心功率图均已接入；第 8 节已加入训练曲线、时域增长、轨迹示例、消融阶梯、误差分布、扰动梯度和内部诊断 7 图，另有 OE 投稿变体 | 终稿只做标签、字号、版面和中英文稿一致性检查，不再把结构阶梯图或 rollout 增长图列为缺失项 |
...
| P10 | 终稿级数值、术语和图表复核 | 第 8 节表格核对、7 张结果图与追踪清单更新 | done：§8 表格与 `analysis/section8_current_evidence/` 对齐；7 图已于 2026-06-18 接入，三项图级遗留于 2026-07-12 完成 |
